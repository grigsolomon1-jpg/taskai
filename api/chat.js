...
Извлеки задачи из текста и верни ТОЛЬКО JSON массив без пояснений:
[{"title":"название","priority":"urgent|important|inwork|later","deadline":"YYYY-MM-DD или null"}]

Правила:
- "срочно", "немедленно", "критично" → priority: "urgent"
- "важно", "обязательно" → priority: "important"  
- без указания → priority: "inwork"
- "потом", "когда-нибудь", "не срочно" → priority: "later"
